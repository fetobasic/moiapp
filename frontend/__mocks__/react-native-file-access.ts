...
export const Util: typeof UtilFunctions = require('react-native-file-access/lib/commonjs/util').Util;
...
class FileSystemMock {
   ...
   */
  public cpExternal = jest.fn(async (source: string, targetName: string, dir: ExternalDir) => {
