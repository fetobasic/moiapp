...
type Props = NativeStackScreenProps<SettingsStackParamList, 'AcChargeInputLimit'>;

const AcChargeInputLimit = ({ navigation, route }: Props) => {
  ...
  const { minLimitA, maxLimitA, maxChgLimitA, maxLimitW } = getPowerLimits(device);
  ...
  return (
    <View style={ApplicationStyles.mainContainer}>
      <Header
        title="AC Charge Port Limits"
        isChangeSaved={isChanged}
        cbSave={onSaveHandler}
        rightSection={renderElement(
          <Pressable testID="rightSectionPress" onPress={() => navigation.navigate('InputLimitsHelp')}>
            <HelpIcon />
          </Pressable>,
        )}
      />
      <ScrollView style={styles.container} contentContainerStyle={styles.scrollContainer}>
        <Text style={styles.description}>
          ...
          Input Limit, AC power pass-through stops and the battery is used as the power source.
        </Text>
      ...
      <Button
        testID="acChargeInputLimitSaveBtn"
        inverse={!isChanged}
        disabled={!isChanged}
...
export default AcChargeInputLimit;
